'use client' // This is required for the animations to work
    ...
    <>
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen text-center text-white p-8 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="https://images.unsplash.com/photo-1599351549021-98a39a04b123?q=80&w=2940&auto=format&fit=crop"
            alt="Elegant and modern salon interior"
            fill
            className="object-cover"
            priority // Ensures the main image loads first
          />
        ...
        <div className="relative z-10">
          ...
          <motion.button
            ...
            className="mt-8 px-8 py-3 bg-yellow-500 text-white font-semibold rounded-full shadow-lg hover:bg-yellow-600 transition-colors transform hover:scale-105"
          >
      ...
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="mt-12 max-w-4xl mx-auto h-96 bg-white rounded-lg shadow-xl flex items-center justify-center border"><p className="text-gray-400 text-lg">App Visual Coming Soon</p></div>
        </div>
      </motion.section>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="mt-16 grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            <div className="p-8 bg-white rounded-lg border shadow-md flex flex-col">
              ...
              <button className="mt-8 w-full px-6 py-3 bg-gray-200 text-gray-800 font-semibold rounded-lg hover:bg-gray-300">Get Started</button>
            </div>
            <div className="p-8 bg-white rounded-lg border-2 border-yellow-500 shadow-xl flex flex-col relative">
              ...
              <button className="mt-8 w-full px-6 py-3 bg-yellow-500 text-white font-semibold rounded-lg hover:bg-yellow-600 transition-colors">Book a Free Consultation</button>
            </div>
            <div className="p-8 bg-white rounded-lg border shadow-md flex flex-col">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="w-48 h-48 md:w-64 md:h-64 rounded-full bg-white shadow-lg flex-shrink-0 overflow-hidden">
              <Image src="/sande-headshot.png" alt="Sande, Founder of Local Lead Bot" width={256} height={256} className="w-full h-full object-cover" />
            </div>
            <div className="text-center md:text-left">
              <h2 className="text-4xl font-bold text-gray-800">From One Business Owner to Another</h2>
              <p className="mt-4 text-lg text-gray-600">&quot;I created Local Lead Bot because I saw so many talented service providers, especially in the beauty industry, overwhelmed by the administrative side of their business. My goal is to give you back your most valuable asset—your time—so you can focus on your clients and your craft.&quot;</p>
              <p className="mt-4 font-semibold text-gray-800">Sande, Founder of Local Lead Bot</p>
            </div>
          </div>
        </div>
      </motion.section>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 bg-gray-50 rounded-lg border text-left">
              <p className="text-gray-600">&quot;Local Lead Bot has been a game-changer. I&apos;m booking more clients than ever, and I&apos;m not glued to my phone answering DMs all night.&quot;</p>
      ...
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">Stop losing clients and start automating your bookings today. Try Local Lead Bot risk-free.</p>
          <button className="mt-8 px-8 py-3 bg-yellow-500 text-white font-semibold rounded-full shadow-lg hover:bg-yellow-600 transition-colors">Start Your Free Trial</button>
        </div>
      </motion.section>
    </>
  );
